...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="toa-sl-content-area">
        ...
        <div class="toa-sl-share">
            <span class="toa-sl-share__label">Condividi:</span>
...
function toaSlCopy(btn) {
    ...
    function onCopied() {
        btn.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true" style="width:16px;height:16px;fill:currentColor;flex-shrink:0"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg> Copiato!';
