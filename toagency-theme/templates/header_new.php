...
<style>html,body{background:#08080a!important;color:#f5f5f3!important}a{color:inherit}</style>
<?php wp_head(); ?>
</head>
...
<nav class="nav" id="mainNav">
    <a href="<?php echo home_url('/'); ?>" class="nav-logo">
        <img src="/wp-content/uploads/2025/09/LogoToanew.png" alt="TOAgency" class="logo-white">
        <img src="/wp-content/uploads/2025/09/LogoToanewBlack.png" alt="TOAgency" class="logo-black">
    </a>
    <div class="nav-links">
