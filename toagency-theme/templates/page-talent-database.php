...
<link rel="stylesheet" href="<?php echo esc_url($theme_uri . '/assets/talent-database-v23.css'); ?>">
<script>
...
<script src="<?php echo esc_url($theme_uri . '/assets/talent-database-v24.js'); ?>" defer></script>
