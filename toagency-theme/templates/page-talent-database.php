...
<link rel="stylesheet" href="<?php echo esc_url($theme_uri . '/assets/talent-database-v79.css'); ?>">
<script>
...
<script src="<?php echo esc_url($theme_uri . '/assets/talent-database-v68.js'); ?>" defer></script>
