...
<?php toa_component('page-hero', array(
    ...
    'subtitle'   => '<strong>' . toa_t('hostess_live', 'hero_subtitle_bold') . '</strong><br>' . toa_t('hostess_live', 'hero_subtitle_text') . '<br><br><span style="color:var(--accent)">' . toa_t('hostess_live', 'hero_badge') . '</span>',
)); ?>
...
<!-- 1. Città -->
<div class="hlf-step">
  <h3><span>1.</span> <?php echo toa_t('hostess_live', 'step1_title'); ?></h3>
  <select class="hlf-select" id="hlf-city" onchange="hlfCalc()">
    <option value=""><?php echo toa_t('hostess_live', 'select_placeholder'); ?></option>
    <optgroup label="<?php echo esc_attr(toa_t('hostess_live', 'group_main')); ?>">
      <option value="milano" data-extra="1.10">Milano (+10%)</option>
    ...
    <optgroup label="<?php echo esc_attr(toa_t('hostess_live', 'group_north')); ?>">
    ...
    <optgroup label="<?php echo esc_attr(toa_t('hostess_live', 'group_center')); ?>">
    ...
    <optgroup label="<?php echo esc_attr(toa_t('hostess_live', 'group_south')); ?>">
...
<!-- 2. Operativi -->
<div class="hlf-step">
  <h3><span>2.</span> <?php echo toa_t('hostess_live', 'step2_title'); ?></h3>
  <div class="hlf-numbers">
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step2_people'); ?></label>
    ...
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step2_days'); ?></label>
      <div class="hlf-num-controls">
    ...
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step2_hours'); ?></label>
  ...
  <div class="hlf-hint"><?php echo toa_t('hostess_live', 'step2_hint'); ?></div>
</div>

<!-- 3. Tipo -->
<div class="hlf-step">
  <h3><span>3.</span> <?php echo toa_t('hostess_live', 'step3_title'); ?></h3>
  <div class="hlf-cards" style="grid-template-columns:1fr 1fr">
    <div class="hlf-card active" onclick="hlfSelect(this,'type','hostess')">
      <div class="hlf-card-title">Hostess</div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step3_hostess_desc'); ?></div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'type','steward')">
      <div class="hlf-card-title">Steward</div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step3_steward_desc'); ?></div>
    </div>
  </div>
</div>
...
<!-- 4. Presenza -->
<div class="hlf-step">
  <h3><span>4.</span> <?php echo toa_t('hostess_live', 'step4_title'); ?></h3>
  <div class="hlf-cards">
    <div class="hlf-card" onclick="hlfSelect(this,'presence','basic')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step4_basic_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step4_basic_desc'); ?></div>
      <div class="hlf-card-price">€119/8h</div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'presence','good')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step4_good_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step4_good_desc'); ?></div>
      <div class="hlf-card-price">€199/8h</div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'presence','model')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step4_model_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step4_model_desc'); ?></div>
      <div class="hlf-card-price">€299/8h</div>
    </div>
  </div>
</div>
...
<!-- 5. Altezza -->
<div class="hlf-step">
  <h3><span>5.</span> <?php echo toa_t('hostess_live', 'step5_title'); ?></h3>
  <div class="hlf-height-grid">
    <button type="button" class="hlf-height-btn active" onclick="hlfHeight(this,'')"><?php echo toa_t('hostess_live', 'step5_any'); ?></button>
    <button type="button" class="hlf-height-btn" onclick="hlfHeight(this,'165+')">165+</button>
    <button type="button" class="hlf-height-btn" onclick="hlfHeight(this,'170+')">170+</button>
    <button type="button" class="hlf-height-btn" onclick="hlfHeight(this,'175+')">175+</button>
    <button type="button" class="hlf-height-btn" onclick="hlfHeight(this,'180+')">180+</button>
  </div>
</div>

<!-- 6. Lingue -->
<div class="hlf-step">
  <h3><span>6.</span> <?php echo toa_t('hostess_live', 'step6_title'); ?></h3>
  <div class="hlf-cards">
    <div class="hlf-card active" onclick="hlfSelect(this,'lang','it')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step6_it'); ?></div>
      <div class="hlf-card-price">Standard</div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'lang','en')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step6_en'); ?></div>
      <div class="hlf-card-price">+15%</div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'lang','multi')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step6_multi'); ?></div>
...
<!-- 7. Pagamento -->
<div class="hlf-step">
  <h3><span>7.</span> <?php echo toa_t('hostess_live', 'step7_title'); ?></h3>
  <div class="hlf-cards" style="grid-template-columns:1fr 1fr">
    <div class="hlf-card active" onclick="hlfSelect(this,'payment','advance')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step7_advance_title'); ?></div>
      <div class="hlf-card-price"><?php echo toa_t('hostess_live', 'step7_advance_label'); ?></div>
    </div>
    <div class="hlf-card" onclick="hlfSelect(this,'payment','post')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'step7_post_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'step7_post_desc'); ?></div>
      <div class="hlf-card-price">+25%</div>
    </div>
  </div>
</div>
...
<!-- 8. Periodo -->
<div class="hlf-step">
  <h3><span>8.</span> <?php echo toa_t('hostess_live', 'step8_title'); ?></h3>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_date_start'); ?></label>
      <input type="date" class="hlf-input" id="hlf-date-start">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_date_end'); ?></label>
...
<!-- 9. Descrizione -->
<div class="hlf-step">
  <h3><span>9.</span> <?php echo toa_t('hostess_live', 'step9_title'); ?></h3>
  <textarea class="hlf-input" id="hlf-description" placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step9_placeholder')); ?>"></textarea>
</div>

<!-- 10. Dati -->
<div class="hlf-step" style="border-bottom:none">
  <h3><span>10.</span> <?php echo toa_t('hostess_live', 'step10_title'); ?></h3>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step10_name_label'); ?></label>
      <input type="text" class="hlf-input" id="hlf-name" required placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step10_name_ph')); ?>">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step10_company_label'); ?></label>
      <input type="text" class="hlf-input" id="hlf-company" required placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step10_company_ph')); ?>">
    </div>
  </div>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step10_email_label'); ?></label>
      <input type="email" class="hlf-input" id="hlf-email" required placeholder="email@azienda.it">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step10_phone_label'); ?></label>
      <input type="tel" class="hlf-input" id="hlf-phone" required placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step10_phone_ph')); ?>">
    </div>
  </div>
  <label class="hlf-privacy">
    <input type="checkbox" id="hlf-consent" required>
    <span><?php echo toa_t('hostess_live', 'privacy_text'); ?> <a href="https://www.iubenda.com/privacy-policy/58462877" target="_blank" style="color:var(--accent);text-decoration:underline"><?php echo toa_t('hostess_live', 'privacy_link'); ?></a></span>
  </label>
  <button type="submit" class="hlf-submit" id="hlfSubmitBtn"><?php echo toa_t('hostess_live', 'submit_btn'); ?></button>
  <p style="text-align:center;font-size:0.7rem;color:var(--gray-4);margin-top:12px;letter-spacing:1px;text-transform:uppercase"><?php echo toa_t('hostess_live', 'submit_note'); ?></p>
</div>
...
<div class="hlf-sticky" id="hlfSticky">
  <div>
    ...
    <div class="hlf-sticky-details" id="hlfStickyDetails"><?php echo toa_t('hostess_live', 'sticky_initial'); ?></div>
  </div>
...
$hlf_str_no_presence = esc_js(toa_t('hostess_live', 'sticky_no_presence'));
$hlf_str_privacy     = esc_js(toa_t('hostess_live', 'alert_privacy'));
?>
<script>
var hlfStrings = {
    noPresence: '<?php echo $hlf_str_no_presence; ?>',
    privacyAlert: '<?php echo $hlf_str_privacy; ?>'
};
</script>
...
function hlfCalcPrice() {
    ...
    if (detailsEl) {
        if (base === 0) {
            detailsEl.textContent = hlfStrings.noPresence;
        } else {
