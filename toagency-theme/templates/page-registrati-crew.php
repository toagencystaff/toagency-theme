...
<script src="<?php echo esc_url($theme_uri . '/assets/crew-form.js'); ?>?v=3.0-20260629" defer></script><!-- TASK hardening-upload-crew 2026-06-04: bump v per forzare reload JS su prod/CDN -->
