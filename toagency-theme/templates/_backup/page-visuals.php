...
<section class="services-section" style="padding-top:40px">
    <div class="services-grid">
        <div class="service-card"><div class="service-icon">ð¸</div><div class="service-name"><?php echo $_t($t['svc_foto']); ?></div><div class="service-desc"><?php echo $_t($t['svc_foto_desc']); ?></div></div>
        <div class="service-card"><div class="service-icon">ð¬</div><div class="service-name"><?php echo $_t($t['svc_video']); ?></div><div class="service-desc"><?php echo $_t($t['svc_video_desc']); ?></div></div>
        <div class="service-card"><div class="service-icon">ð±</div><div class="service-name">Social</div><div class="service-desc"><?php echo $_t($t['svc_social_desc']); ?></div></div>
        <div class="service-card"><div class="service-icon">ðï¸</div><div class="service-name">E-Commerce</div><div class="service-desc"><?php echo $_t($t['svc_ecom_desc']); ?></div></div>
        <div class="service-card"><div class="service-icon">ð¤</div><div class="service-name">AI Enhanced</div><div class="service-desc"><?php echo $_t($t['svc_ai_desc']); ?></div></div>
        <div class="service-card"><div class="service-icon">ð¨</div><div class="service-name"><?php echo $_t($t['svc_postprod']); ?></div><div class="service-desc"><?php echo $_t($t['svc_postprod_desc']); ?></div></div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="price-table">
            <table>
                ...
                <tbody>
                    <tr><td><?php echo $_t($t['row_still']); ?></td><td>&euro;5 â &euro;10 / foto</td></tr>
                    <tr><td><?php echo $_t($t['row_flatlay']); ?></td><td>&euro;8 â &euro;15 / foto</td></tr>
                    <tr><td><?php echo $_t($t['row_ghost']); ?></td><td>&euro;12 â &euro;20 / foto</td></tr>
                    <tr><td><?php echo $_t($t['row_indossato']); ?></td><td>&euro;15 â &euro;30 / foto</td></tr>
                    <tr><td><?php echo $_t($t['row_lifestyle']); ?></td><td>&euro;20 â &euro;50 / foto</td></tr>
                    <tr><td><?php echo $_t($t['row_vidprod']); ?></td><td>&euro;200 â &euro;500 / video</td></tr>
                    <tr><td><?php echo $_t($t['row_reel']); ?></td><td>&euro;150 â &euro;300 / video</td></tr>
                </tbody>
            </table>
