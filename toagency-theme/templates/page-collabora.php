...
$t = array(
    ...
    'cta_talent_url' => array(
        'it' => '/registrati-talent/',
        'en' => '/en/register-talent/',
        'fr' => '/fr/inscription-talent/',
        'es' => '/es/registrate-como-talent/',
    ),
    'cta_crew_url' => array(
        'it' => '/registrati-crew/',
        'en' => '/en/register-crew/',
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <div style="margin-top:24px">
                <a href="<?php echo $_t($t['cta_talent_url']); ?>" class="btn-hero btn-hero-primary" style="padding:12px 20px;font-size:0.75rem"><?php echo $_t($t['registrati']); ?></a>
            </div>
        </div>
        <div class="feature-card">
