...
<script src="<?php echo esc_url($theme_uri . '/assets/talent-form-v40.js'); ?>?v=20260629c" defer></script><!-- FIX 2026-06-25 marco: bump v — foto retry + recupero + check email step1; FIX 2026-06-28 marco: bump v — blocco doppione nome+cognome+dob -->
