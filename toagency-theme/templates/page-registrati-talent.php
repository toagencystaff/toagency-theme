...
?>
<!-- TOA-TALENT-FORM-V1 -->
<link rel="stylesheet" href="<?php echo esc_url($theme_uri . '/assets/talent-form.css'); ?>?v=1.0">
<script>
        ...
        <div class="toa-talent-step" data-step="4">
            ...
            <div class="toa-talent-upload-section">
                ...
                <div class="toa-talent-dropzone" id="toaTalentPhotosDrop">
                    ...
                    <div class="toa-talent-dropzone-hint">JPG, PNG • <?php echo _ht_talent(array('it'=>'max 5MB per file','en'=>'max 5MB','fr'=>'max 5MB','es'=>'max 5MB')); ?></div>
...
<script src="<?php echo esc_url($theme_uri . '/assets/talent-form.js'); ?>?v=3.4" defer></script>
