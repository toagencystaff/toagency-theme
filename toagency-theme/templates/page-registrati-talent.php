                        ...
                        <?php if (!empty($al['video'])): ?>
                            <p class="toa-alb-video-nota<?php echo $al['video'] === 'video_selftape' ? ' forte' : ''; ?>"><?php
                                echo $al['video'] === 'video_selftape'
                                    ? _ht_talent(array(
                                        'it'=>'🎬 <strong>Self-tape — per gli attori è la cosa più importante di tutte.</strong><br>1. Apri dicendo la data di oggi: «Oggi è il 1 settembre 2026».<br>2. Poi solo il <strong>nome</strong> e l\'età. <span class="toa-alb-vietato">⛔ Mai il cognome: se lo dici il video non viene accettato.</span><br>3. Presentati e recita qualche battuta, un minuto basta. Telefono in verticale, luce davanti, sfondo neutro.<br>4. Primo piano e figura intera. Senza self-tape le produzioni non ti convocano.',
                                        'en'=>'🎬 <strong>Self-tape — for actors this matters more than anything else.</strong><br>1. Open by saying today\'s date: "Today is 1 September 2026".<br>2. Then only your <strong>first name</strong> and age. <span class="toa-alb-vietato">⛔ Never your surname: if you say it the video is not accepted.</span><br>3. Introduce yourself and perform a few lines, one minute is enough. Phone vertical, light in front, plain background.<br>4. Close-up and full length. Without a self-tape productions will not call you.',
                                        'fr'=>'🎬 <strong>Self-tape — pour les comédiens c\'est ce qui compte le plus.</strong><br>1. Commence par la date du jour : « Aujourd\'hui nous sommes le 1er septembre 2026 ».<br>2. Ensuite seulement ton <strong>prénom</strong> et ton âge. <span class="toa-alb-vietato">⛔ Jamais ton nom de famille : si tu le dis la vidéo n\'est pas acceptée.</span><br>3. Présente-toi et joue quelques répliques, une minute suffit. Téléphone en vertical, lumière de face, fond neutre.<br>4. Gros plan et plein pied. Sans self-tape les productions ne te convoquent pas.',
                                        'es'=>'🎬 <strong>Self-tape — para los actores es lo más importante de todo.</strong><br>1. Empieza diciendo la fecha de hoy: «Hoy es 1 de septiembre de 2026».<br>2. Luego solo tu <strong>nombre</strong> y tu edad. <span class="toa-alb-vietato">⛔ Nunca el apellido: si lo dices el vídeo no se acepta.</span><br>3. Preséntate e interpreta unas líneas, un minuto basta. Móvil en vertical, luz de frente, fondo neutro.<br>4. Primer plano y cuerpo entero. Sin self-tape las producciones no te llaman.',
                                    ))
                                    : _ht_talent(array(
                                        'it'=>'🎥 <strong>Video di presentazione — 30 secondi, in verticale.</strong><br>1. Per prima cosa di\' la data di oggi: «Oggi è il 1 settembre 2026».<br>2. Poi solo il <strong>nome</strong> e l\'età. <span class="toa-alb-vietato">⛔ Mai il cognome: se lo dici il video non viene accettato.</span><br>3. Parla per 30 secondi di quello che vuoi, anche del tempo che fa oggi nella tua città: serve solo a sentire la tua voce.<br>4. Inquadrati prima in primo piano e poi a figura intera. Fai vedere le mani, il sorriso e i denti.',
                                        'en'=>'🎥 <strong>Presentation video — 30 seconds, vertical.</strong><br>1. Start by saying today\'s date: "Today is 1 September 2026".<br>2. Then only your <strong>first name</strong> and your age. <span class="toa-alb-vietato">⛔ Never your surname: if you say it the video is not accepted.</span><br>3. Talk for 30 seconds about anything, even today\'s weather in your city: it is only to hear your voice.<br>4. Film yourself in close-up first, then full length. Show your hands, your smile and your teeth.',
                                        'fr'=>'🎥 <strong>Vidéo de présentation — 30 secondes, en vertical.</strong><br>1. Commence par dire la date du jour : « Aujourd\'hui nous sommes le 1er septembre 2026 ».<br>2. Ensuite seulement ton <strong>prénom</strong> et ton âge. <span class="toa-alb-vietato">⛔ Jamais ton nom de famille : si tu le dis la vidéo n\'est pas acceptée.</span><br>3. Parle 30 secondes de ce que tu veux, même du temps qu\'il fait aujourd\'hui dans ta ville : c\'est juste pour entendre ta voix.<br>4. Filme-toi d\'abord en gros plan puis en plein pied. Montre tes mains, ton sourire et tes dents.',
                                        'es'=>'🎥 <strong>Vídeo de presentación — 30 segundos, en vertical.</strong><br>1. Lo primero, di la fecha de hoy: «Hoy es 1 de septiembre de 2026».<br>2. Luego solo tu <strong>nombre</strong> y tu edad. <span class="toa-alb-vietato">⛔ Nunca el apellido: si lo dices el vídeo no se acepta.</span><br>3. Habla 30 segundos de lo que quieras, incluso del tiempo que hace hoy en tu ciudad: sirve solo para oír tu voz.<br>4. Grábate primero en primer plano y después de cuerpo entero. Enseña las manos, la sonrisa y los dientes.',
                                    ));
                            ?></p>
                        <?php endif; ?>
