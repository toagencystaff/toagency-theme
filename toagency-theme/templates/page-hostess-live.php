...
<div class="hlf-step" id="hlf-step-figure">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step1_title'); ?></div>
  </div>
  <p class="hlf-step-sub"><?php echo toa_t('hostess_live', 'step1_sub'); ?></p>

  <div class="hlf-acc">
    <button type="button" class="hlf-acc-head" onclick="hlfAccToggle(this)">
      <i class="hlf-acc-icon">＋</i>
      <span class="hlf-acc-label"><?php echo toa_t('hostess_live', 'acc1_label'); ?></span>
      <span class="hlf-acc-hint"><?php echo toa_t('hostess_live', 'acc1_hint'); ?></span>
    </button>
    <div class="hlf-acc-body">
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'standard')" data-aesthetic="1">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_hostess_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_hostess_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_hostess_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'immagine')" data-aesthetic="1">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_immagine_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_immagine_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_immagine_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'accrediti')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_accrediti_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_accrediti_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_accrediti_price'); ?></div>
      </div>
    </div>
  </div>
  ...
  <div class="hlf-acc">
    <button type="button" class="hlf-acc-head" onclick="hlfAccToggle(this)">
      <i class="hlf-acc-icon">＋</i>
      <span class="hlf-acc-label"><?php echo toa_t('hostess_live', 'acc2_label'); ?></span>
      <span class="hlf-acc-hint"><?php echo toa_t('hostess_live', 'acc2_hint'); ?></span>
    </button>
    <div class="hlf-acc-body">
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'promoter')" data-aesthetic="1">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_promoter_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_promoter_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_promoter_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'modello')" data-aesthetic="1">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_modello_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_modello_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_modello_price'); ?></div>
      </div>
    </div>
  </div>
  ...
  <div class="hlf-acc">
    <button type="button" class="hlf-acc-head" onclick="hlfAccToggle(this)">
      <i class="hlf-acc-icon">＋</i>
      <span class="hlf-acc-label"><?php echo toa_t('hostess_live', 'acc3_label'); ?></span>
      <span class="hlf-acc-hint"><?php echo toa_t('hostess_live', 'acc3_hint'); ?></span>
    </button>
    <div class="hlf-acc-body">
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'interprete')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_interprete_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_interprete_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_interprete_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'interprete_multi')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_interprete_multi_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_interprete_multi_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_interprete_multi_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'coordinatore')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_coordinatore_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_coordinatore_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_coordinatore_price'); ?></div>
      </div>
    </div>
  </div>
  ...
  <div class="hlf-acc">
    <button type="button" class="hlf-acc-head" onclick="hlfAccToggle(this)">
      <i class="hlf-acc-icon">＋</i>
      <span class="hlf-acc-label"><?php echo toa_t('hostess_live', 'acc4_label'); ?></span>
      <span class="hlf-acc-hint"><?php echo toa_t('hostess_live', 'acc4_hint'); ?></span>
    </button>
    <div class="hlf-acc-body">
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'driver')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_driver_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_driver_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_driver_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'driver_van')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_driver_van_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_driver_van_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_driver_van_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'tecnico')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_tecnico_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_tecnico_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_tecnico_price'); ?></div>
      </div>
      <div class="hlf-fig-row" onclick="hlfSelectFigure(this,'runner')">
        <div class="hlf-fig-info">
          <div class="hlf-fig-title"><?php echo toa_t('hostess_live', 'fig_runner_title'); ?></div>
          <div class="hlf-fig-desc"><?php echo toa_t('hostess_live', 'fig_runner_desc'); ?></div>
        </div>
        <div class="hlf-fig-price"><?php echo toa_t('hostess_live', 'fig_runner_price'); ?></div>
      </div>
    </div>
  </div>
...
<div class="hlf-step hlf-step--hidden" id="hlf-step-presence">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'presence_title'); ?></div>
  </div>
  <div class="hlf-step-sub"><?php echo toa_t('hostess_live', 'presence_sub'); ?></div>
  <div class="hlf-cards">
    <div class="hlf-card active" onclick="hlfSelectPresence(this,'standard')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'presence_standard_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'presence_standard_desc'); ?></div>
      <div class="hlf-card-price"><?php echo toa_t('hostess_live', 'presence_standard_price'); ?></div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPresence(this,'good')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'presence_good_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'presence_good_desc'); ?></div>
      <div class="hlf-card-price">+15%</div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPresence(this,'high')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'presence_high_title'); ?></div>
      <div class="hlf-card-desc"><?php echo toa_t('hostess_live', 'presence_high_desc'); ?></div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'country_city_title'); ?></div>
  </div>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'country_label'); ?></label>
      <select class="hlf-select" id="hlf-country" onchange="hlfCountryChange()">
        <option value="">— <?php echo toa_t('hostess_live', 'country_placeholder'); ?> —</option>
        ...
        <option value="OTHER"><?php echo toa_t('hostess_live', 'country_other'); ?></option>
      </select>
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'city_label'); ?></label>
      <select class="hlf-select" id="hlf-city" onchange="hlfCalc()" disabled>
        <option value="">— <?php echo toa_t('hostess_live', 'city_first_select'); ?> —</option>
      </select>
    </div>
  </div>
  <div class="hlf-hint"><?php echo toa_t('hostess_live', 'country_hint'); ?></div>
</div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step3_title'); ?></div>
  </div>
  <div class="hlf-numbers">
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step3_people'); ?></label>
    ...
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step3_days'); ?></label>
      <div class="hlf-num-controls">
    ...
    <div class="hlf-num-group">
      <label><?php echo toa_t('hostess_live', 'step3_hours'); ?></label>
  ...
  <div class="hlf-hint"><?php echo toa_t('hostess_live', 'step3_hint'); ?></div>
</div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step4_title'); ?></div>
  </div>
  <div class="hlf-step-sub"><?php echo toa_t('hostess_live', 'step4_sub'); ?></div>
  <div class="hlf-cards hlf-cards--pay">
    <div class="hlf-card active" onclick="hlfSelectPay(this,'advance')">
      <div class="hlf-card-tag"><?php echo toa_t('hostess_live', 'pay_advance_tag'); ?></div>
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'pay_advance_title'); ?></div>
      <div class="hlf-card-mechanism"><?php echo toa_t('hostess_live', 'pay_advance_desc'); ?></div>
      <div class="hlf-card-price"><?php echo toa_t('hostess_live', 'pay_advance_price'); ?></div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPay(this,'split24')">
      <div class="hlf-card-tag"><?php echo toa_t('hostess_live', 'pay_split24_tag'); ?></div>
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'pay_split24_title'); ?></div>
      <div class="hlf-card-mechanism"><?php echo toa_t('hostess_live', 'pay_split24_desc'); ?></div>
      <div class="hlf-card-price">+10%</div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPay(this,'split30')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'pay_split30_title'); ?></div>
      <div class="hlf-card-mechanism"><?php echo toa_t('hostess_live', 'pay_split30_desc'); ?></div>
      <div class="hlf-card-price">+20%</div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPay(this,'post30')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'pay_post30_title'); ?></div>
      <div class="hlf-card-mechanism"><?php echo toa_t('hostess_live', 'pay_post30_desc'); ?></div>
      <div class="hlf-card-price">+30%</div>
      <div class="hlf-card-warn"><?php echo toa_t('hostess_live', 'pay_approval_warn'); ?></div>
    </div>
    <div class="hlf-card" onclick="hlfSelectPay(this,'post60')">
      <div class="hlf-card-title"><?php echo toa_t('hostess_live', 'pay_post60_title'); ?></div>
      <div class="hlf-card-mechanism"><?php echo toa_t('hostess_live', 'pay_post60_desc'); ?></div>
      <div class="hlf-card-price">+40%</div>
      <div class="hlf-card-warn"><?php echo toa_t('hostess_live', 'pay_approval_warn'); ?></div>
    </div>
  </div>
  <div class="hlf-disclaimer"><?php echo toa_t('hostess_live', 'pay_disclaimer'); ?></div>
</div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step5_title'); ?></div>
  </div>
  <div class="hlf-step-sub"><?php echo toa_t('hostess_live', 'step5_sub'); ?></div>
  <div class="hlf-checks">
    <label class="hlf-check" onclick="hlfToggleCheck(this)">
      ...
      <div><div class="hlf-check-label"><?php echo toa_t('hostess_live', 'sup_weekend'); ?></div><div class="hlf-check-extra">+10%</div></div>
    </label>
    <label class="hlf-check" onclick="hlfToggleCheck(this)">
      <input type="checkbox" name="sup_night" value="night">
      <div class="hlf-check-box"></div>
      <div><div class="hlf-check-label"><?php echo toa_t('hostess_live', 'sup_night'); ?></div><div class="hlf-check-extra">+15%</div></div>
    </label>
    <label class="hlf-check" onclick="hlfToggleCheck(this)">
      <input type="checkbox" name="sup_urgent" value="urgent">
      <div class="hlf-check-box"></div>
      <div><div class="hlf-check-label"><?php echo toa_t('hostess_live', 'sup_urgent'); ?></div><div class="hlf-check-extra">+15%</div></div>
    </label>
    <label class="hlf-check" onclick="hlfToggleCheck(this)">
      <input type="checkbox" name="sup_dress" value="dress">
      <div class="hlf-check-box"></div>
      <div><div class="hlf-check-label"><?php echo toa_t('hostess_live', 'sup_dress'); ?></div><div class="hlf-check-extra">+5%</div></div>
    </label>
  </div>
</div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step6_title'); ?></div>
  </div>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step6_date_start'); ?></label>
      <input type="date" class="hlf-input" id="hlf-date-start">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step6_date_end'); ?></label>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step7_title'); ?></div>
  </div>
  <div class="hlf-step-sub"><?php echo toa_t('hostess_live', 'step7_sub'); ?></div>
  <textarea class="hlf-input" id="hlf-description" placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step7_placeholder')); ?>"></textarea>
</div>
...
<div class="hlf-step">
  <div class="hlf-step-head">
    ...
    <div class="hlf-step-title"><?php echo toa_t('hostess_live', 'step8_title'); ?></div>
  </div>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_name_label'); ?></label>
      <input type="text" class="hlf-input" id="hlf-name" required placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step8_name_ph')); ?>">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_company_label'); ?></label>
      <input type="text" class="hlf-input" id="hlf-company" required placeholder="<?php echo esc_attr(toa_t('hostess_live', 'step8_company_ph')); ?>">
    </div>
  </div>
  <div class="hlf-row">
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_email_label'); ?></label>
      <input type="email" class="hlf-input" id="hlf-email" required placeholder="email@azienda.it">
    </div>
    <div>
      <label class="hlf-label"><?php echo toa_t('hostess_live', 'step8_phone_label'); ?></label>
      <input type="tel" class="hlf-input" id="hlf-phone" required placeholder="+39...">
    </div>
  </div>
  <div class="hlf-hint" style="margin-bottom:16px"><?php echo toa_t('hostess_live', 'extra_services_hint'); ?></div>
  <label class="hlf-privacy">
    <input type="checkbox" id="hlf-consent" required>
    <span><?php printf(toa_t('hostess_live', 'privacy_text'), '<a href="https://www.iubenda.com/privacy-policy/58462877" target="_blank" style="color:var(--accent);text-decoration:underline">', '</a>'); ?></span>
  </label>
  <button type="submit" class="hlf-submit" id="hlfSubmitBtn"><?php echo toa_t('hostess_live', 'submit_btn'); ?></button>
  <div class="hlf-disclaimer" style="margin-top:16px">
    <strong><?php echo toa_t('hostess_live', 'price_note_title'); ?></strong><br>
    <?php echo toa_t('hostess_live', 'price_note_text'); ?>
  </div>
</div>
...
<div class="hlf-sticky" id="hlfSticky">
  ...
  <button type="button" class="hlf-sticky-btn" onclick="document.getElementById('hlfSubmitBtn').scrollIntoView({behavior:'smooth'})"><?php echo toa_t('hostess_live', 'sticky_btn'); ?></button>
</div>
...
(function(){
  ...
  var CITIES={
    ...
    ES:[{v:'madrid',l:'Madrid',m:1.15},{v:'barcelona',l:'Barcelona',m:1.15},{v:'valencia',l:'Valencia',m:1.05},{v:'sevilla',l:'Sevilla',m:1.05},{v:'bilbao',l:'Bilbao',m:1.05},{v:'malaga',l:'Málaga',m:1.05},{v:'zaragoza',l:'Zaragoza',m:1.05},{v:'alicante',l:'Alicante',m:1.05}],
    FR:[{v:'paris',l:'Paris',m:1.25},{v:'marseille',l:'Marseille',m:1.10},{v:'lyon',l:'Lyon',m:1.10},{v:'toulouse',l:'Toulouse',m:1.10},{v:'nice',l:'Nice',m:1.10},{v:'nantes',l:'Nantes',m:1.10},{v:'strasbourg',l:'Strasbourg',m:1.10},{v:'bordeaux',l:'Bordeaux',m:1.10},{v:'montecarlo',l:'Monte-Carlo / Monaco',m:1.30},{v:'cannes',l:'Cannes',m:1.20}],
    GB:[{v:'london',l:'London',m:1.30},{v:'manchester',l:'Manchester',m:1.15},{v:'birmingham',l:'Birmingham',m:1.10},{v:'glasgow',l:'Glasgow',m:1.10},{v:'liverpool',l:'Liverpool',m:1.10},{v:'edinburgh',l:'Edinburgh',m:1.15},{v:'leeds',l:'Leeds',m:1.10},{v:'bristol',l:'Bristol',m:1.10}],
    DE:[{v:'berlin',l:'Berlin',m:1.15},{v:'munich',l:'München',m:1.20},{v:'hamburg',l:'Hamburg',m:1.15},{v:'frankfurt',l:'Frankfurt',m:1.20},{v:'koln',l:'Köln',m:1.10},{v:'stuttgart',l:'Stuttgart',m:1.10},{v:'dusseldorf',l:'Düsseldorf',m:1.15},{v:'hannover',l:'Hannover',m:1.10},{v:'nurnberg',l:'Nürnberg',m:1.10}],
    CH:[{v:'zurich',l:'Zürich',m:1.30},{v:'geneve',l:'Genève',m:1.30},{v:'basel',l:'Basel',m:1.25},{v:'lausanne',l:'Lausanne',m:1.25},{v:'lugano',l:'Lugano',m:1.20}],
    BE:[{v:'bruxelles',l:'Bruxelles',m:1.15},{v:'antwerpen',l:'Antwerpen',m:1.10},{v:'gent',l:'Gent',m:1.10},{v:'brugge',l:'Brugge',m:1.10}],
  ...
  window.hlfCountryChange=function(){
    ...
    citySel.innerHTML='';
    if(!country){
      citySel.innerHTML='<option value="">— <?php echo esc_js(toa_t('hostess_live', 'js_city_first_select')); ?> —</option>';
      citySel.disabled=true;calc();return;
    }
    if(country==='OTHER'){
      citySel.innerHTML='<option value="altra" data-mult="0"><?php echo esc_js(toa_t('hostess_live', 'js_city_other')); ?></option>';
      citySel.disabled=false;calc();return;
    }
    var cities=CITIES[country]||[];
    var html='<option value="">— <?php echo esc_js(toa_t('hostess_live', 'js_city_select')); ?> —</option>';
    cities.forEach(function(c){html+='<option value="'+c.v+'" data-mult="'+c.m+'">'+c.l+'</option>';});
    html+='<option value="altra" data-mult="0"><?php echo esc_js(toa_t('hostess_live', 'js_city_other')); ?></option>';
  ...
  function updatePresenceVisibility(){
    ...
    if(presStep){presStep.classList.toggle('hlf-step--hidden',!show);}
  ...
  function calc(){
    ...
    if(detEl){
      if(!state.figure)detEl.textContent='<?php echo esc_js(toa_t('hostess_live', 'js_no_figure')); ?>';
      else if(cityM===0)detEl.textContent=LABELS[state.figure]+' — <?php echo esc_js(toa_t('hostess_live', 'js_no_city')); ?>';
    ...
    if(savEl){
      if(state.payment==='advance'&&totalMax>0){
        ...
        savEl.textContent=s>0?'<?php echo esc_js(toa_t('hostess_live', 'js_saving')); ?> €'+s.toLocaleString('it-IT')+' <?php echo esc_js(toa_t('hostess_live', 'js_vs60')); ?>':'';}
      else if(state.payment!=='advance'&&totalAdv>0){
        var d=total-totalAdv;
        savEl.textContent=d>0?'<?php echo esc_js(toa_t('hostess_live', 'js_saving')); ?> €'+d.toLocaleString('it-IT')+' <?php echo esc_js(toa_t('hostess_live', 'js_save_advance')); ?>':'';}
  ...
  window.hlfSelectFigure=function(el,fig){
    ...
    el.classList.add('active');state.figure=fig;updatePresenceVisibility();calc();
  };
...
(function(){
  ...
  var TIMEOUT=10000;
  function goTnx(codice){var url=TNX;if(codice)url+=(url.indexOf('?')>-1?'&':'?')+'ref='+encodeURIComponent(codice);window.location.href=url;}
  function payload(){
    var d={};
  ...
  function createCrmJob(d){
    ...
    .then(function(res){
      ...
      return fetch(jobUrl,{method:'POST',body:fd2}).then(function(r){return r.json();}).then(function(res2){return(res2.success)?codice:null;});
    })
    .then(function(codice){if(codice){try{sessionStorage.setItem('toa_job_code',codice);}catch(e){}}goTnx(codice);})
    .catch(function(){goTnx(null);});
  }
  ...
  if(form){
    form.addEventListener('submit',function(e){
      ...
      if(consent&&!consent.checked){alert('<?php echo esc_js(toa_t('hostess_live', 'js_privacy_alert')); ?>');return;}
      ...
      fetch(CRM_LEAD,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(d)})
      .then(function(r){return r.json();})
      .then(function(){clearTimeout(safetyTimer);createCrmJob(d);})
      .catch(function(){clearTimeout(safetyTimer);createCrmJob(d);});
    });
  }
})();
</script>
