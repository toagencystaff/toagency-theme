    ...
    <div class="toa-footer-landing-links__inner">
      ...
      <div class="toa-fll-col">
        ...
        <ul>
          ...
          <li><a href="<?php echo _ht(['it'=>home_url('/casting-italia/'),'en'=>home_url('/en/services-by-city/'),'fr'=>home_url('/fr/services-par-ville/'),'es'=>home_url('/es/servicios-por-ciudad/')]); ?>" class="toa-fll-more"><?php echo _ht(['it'=>'Tutte le città →','en'=>'All cities →','fr'=>'Toutes les villes →','es'=>'Todas las ciudades →']); ?></a></li>
        </ul>
      </div>
      ...
      <div class="toa-fll-col">
        ...
        <ul>
          ...
          <li><a href="<?php echo _ht(['it'=>home_url('/casting-italia/'),'en'=>home_url('/en/services-by-city/'),'fr'=>home_url('/fr/services-par-ville/'),'es'=>home_url('/es/servicios-por-ciudad/')]); ?>" class="toa-fll-more"><?php echo _ht(['it'=>'Tutti i servizi →','en'=>'All services →','fr'=>'Tous les services →','es'=>'Todos los servicios →']); ?></a></li>
        </ul>
      </div>
