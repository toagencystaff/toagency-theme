...
?>
<a href="<?php echo esc_url($wa_href); ?>" class="toa-whatsapp-btn" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr(_t_raw($wa_aria)); ?>" onclick="toaTrackContact('whatsapp','sticky-button')">
...
<script>
/* Tracciamento click WhatsApp sticky - stesso helper guardato di quick-contacts */
