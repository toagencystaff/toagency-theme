...
function toagency_page_templates($templates) {
    ...
    $templates['templates/page-models3.php']         = 'Models';
    $templates['templates/page-hostess-eventi20.php']        = 'Hostess & Steward';
    $templates['templates/page-actors3.php']         = 'Actors';
...
add_action('wp_footer', function() {
    ...
    (function(){
      ...
      var b1=[{t:'BURBERRY',c:'b-burberry'},{t:'La Romana <small>DAL 1947</small>',c:'b-laromana'},{t:'CRAZY PIZZA',c:'b-crazypizza'},{t:'IMPERIAL',c:'b-imperial'},{t:'PATAGONIA',c:'b-patagonia'},{t:'REAL MADRID',c:'b-realmadrid'},{t:'MANCHESTER UNITED',c:'b-manutd'},{t:'AS ROMA',c:'b-roma'},{t:'NOVOTEL',c:'b-novotel'},{t:'JUVENTUS',c:'b-juventus'},{t:'FERRARI',c:'b-ferrari'},{t:'BMW',c:'b-bmw'},{t:'SAMSUNG',c:'b-samsung'},{t:'RED BULL',c:'b-redbull'},{t:'MERCEDES-BENZ',c:'b-mercedes'},{t:'VOGUE SPOSA',c:'b-vogue'},{t:'KAPPA',c:'b-kappa'},{t:'SKY',c:'b-sky'},{t:'MASERATI',c:'b-maserati'},{t:'FIAT',c:'b-fiat'},{t:'VODAFONE',c:'b-vodafone'},{t:'AUDI',c:'b-audi'},{t:'JEEP',c:'b-jeep'},{t:'MICHELIN',c:'b-michelin'},{t:'KINDER',c:'b-kinder'},{t:"L'ORÉAL",c:'b-loreal'},{t:'GQ ITALIA',c:'b-gq'},{t:'ALFA ROMEO',c:'b-alfaromeo'},{t:'EATALY',c:'b-eataly'},{t:'K-WAY',c:'b-kway'},{t:'FORMULA 1',c:'b-formula1'},{t:'MOTOGP',c:'b-motogp'},{t:'LUXOTTICA',c:'b-luxottica'},{t:'SANREMO',c:'b-sanremo'},{t:'MISS UNIVERSE',c:'b-missuniverse'},{t:'EDISON',c:'b-edison'},{t:'QC TERME',c:'b-qcterme'},{t:'POLICE',c:'b-police'}];
      var b2=[{t:'CISALFA',c:'b-cisalfa'},{t:'JOMA',c:'b-joma'},{t:'ARENA',c:'b-arena'},{t:'FC BARCELONA',c:'b-barcelona'},{t:'VALENCIA CF',c:'b-valencia'},{t:'SSC NAPOLI',c:'b-napoli'},{t:'BORUSSIA DORTMUND',c:'b-dortmund'},{t:'COOLTRA',c:'b-cooltra'},{t:'GRITTI',c:'b-gritti'},{t:'FC INTERNAZIONALE',c:'b-inter'},{t:'WOLT',c:'b-wolt'},{t:'AXA',c:'b-axa'},{t:'SERIE A',c:'b-seriea'},{t:'LOACKER',c:'b-loacker'},{t:'MEDIASET',c:'b-mediaset'},{t:'PARIS FASHION WEEK',c:'b-pfw'},{t:'SALONE DEL MOBILE',c:'b-salone'},{t:'LA RINASCENTE',c:'b-rinascente'},{t:'EXPO 2015',c:'b-expo'},{t:'FIERA MILANO',c:'b-fieramilano'},{t:'RIMINI FIERA',c:'b-rimini'},{t:'BOLOGNA FIERE',c:'b-bologna'},{t:'TEATRO REGIO',c:'b-teatro'},{t:'VIRGIN ACTIVE',c:'b-virgin'},{t:'WRANGLER',c:'b-wrangler'},{t:'FIORUCCI',c:'b-fiorucci'},{t:'TORINO FC',c:'b-torino'},{t:'ALGIDA',c:'b-algida'},{t:'MIZUNO',c:'b-mizuno'},{t:'KINGS LEAGUE',c:'b-kingsleague'},{t:'AIA',c:'b-aia'},{t:'REVLON',c:'b-revlon'},{t:'COIN',c:'b-coin'},{t:'NM LAB',c:'b-nmlab'},{t:'DAN JOHN',c:'b-danjohn'},{t:'GARNIER',c:'b-garnier'},{t:'SEPHORA',c:'b-sephora'},{t:'VILLA CRESPI',c:'b-villacrespi'}];
